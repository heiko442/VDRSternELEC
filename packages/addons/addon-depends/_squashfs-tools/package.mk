...
PKG_LICENSE="GPL"
PKG_SITE="http://tinycorelinux.net/14.x/x86_64/tcz/src/squashfs-tools"
PKG_URL="http://tinycorelinux.net/14.x/x86_64/tcz/src/squashfs-tools/squashfs-tools-4.6.1.tar.gz"
